                    ...
                    @foreach ($item->events as $event)
                        ...
                        <div class=content>
                            ...
                            <div class="icon-container">
                                ...
                                <button class="icon-button trash-button" data-cart-id="{{ $item->id }}"><i class="fas fa-trash-alt"></i></button>
                                <div class="quantity-container">
                                    <button class="quantity-button decrease-button" data-cart-id="{{ $item->id }}">-</button>
                                    <input type="number" value="{{ $item->Quantity }}" min="1" class="quantity-input" data-cart-id="{{ $item->id }}">
                                    <button class="quantity-button increase-button" data-cart-id="{{ $item->id }}">+</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
